  ...
  return (
    <section id="features" className="section-block pt-32">
      <div className="mx-auto max-w-6xl">
        ...
        <StaggerChildren staggerDelay={0.08} className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {messages.features_grid.items.map((item, index) => (
            <StaggerItem key={index}>
              <article
                className="group relative flex flex-col overflow-hidden rounded-3xl border border-gray-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-full"
              >
