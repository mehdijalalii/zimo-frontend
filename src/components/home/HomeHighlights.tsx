  ...
  return (
    <section className="section-block pt-8 md:pt-12 bg-[#841474]/[0.12]">
      <div className="mx-auto max-w-6xl">
        ...
        <StaggerChildren staggerDelay={0.15} className="bento-grid">
          <StaggerItem>
            <Link
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <svg className="h-6 w-6 text-[#841474]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <FadeIn direction="up" delay={0.3} className="mt-10 flex justify-center">
          <Link
            href={getHref(locale, 'features')}
