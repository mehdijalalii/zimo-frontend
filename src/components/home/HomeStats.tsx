  ...
  return (
    <section className="section-block">
      <div className="mx-auto max-w-6xl">
        <div className="cta-panel grid grid-cols-2 gap-y-10 rounded-3xl bg-[#841474] px-8 py-12 md:grid-cols-4 md:px-12 md:gap-y-0">
          ...
          <div className="text-center border-r border-white/10 md:border-r-0 md:border-l md:border-white/20">
